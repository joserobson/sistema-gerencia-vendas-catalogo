...
public class MensagensUtil {
    ...
    //BANCO DE DADOS
    public static String MENSAGEM_ERRO_CONECTAR_BANCO="NÃO É POSSÍVEL CARREGAR O SISTEMA, ERRO AO CONECTAR COM O BANCO. ENTRE EM CONTATO COM O SUPORTE TÉCNICO.";
