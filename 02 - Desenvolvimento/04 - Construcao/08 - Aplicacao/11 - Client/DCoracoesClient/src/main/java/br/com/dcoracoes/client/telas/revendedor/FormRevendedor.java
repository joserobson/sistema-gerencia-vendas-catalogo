...
public class FormRevendedor extends javax.swing.JFrame implements InterfaceCadastroCompleto {
    ...
    private void buscarUltimoCadastro() {
        ...
        try {
            viewRevendedor = serverImpl.recUltimoRevendedorCadastro();
            if (viewRevendedor != null) {
                setRevendedor(viewRevendedor);
            } else {
                createNew();
            }
    ...
    private void initComponents() {
        ...
        btnInformacoesComplementares.setFont(new java.awt.Font("Tahoma", 1, 10));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblAlertaProspeccao, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
                    .addComponent(btnInformacoesComplementares, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE)
                    .addComponent(btnProspeccoes, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(tablePanelDados, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 990, Short.MAX_VALUE)
...
//        jtxtLimiteCredito.setText(MetodosUtil.formatarValorDinheiro(jtxtLimiteCredito.getText()));
    ...
    public void pushToModel() {
        ...
        viewRevendedor.getRevendedor().setDataCadastro((Date) jtxtDataCadastro.getValue());
    ...
    public void salvar() {
        try {
            if (validarTela()) {
                pushToModel();
                if (mantemRevendedor(viewRevendedor)) {
            ...
            if(ex.getMessage().equalsIgnoreCase(ConstanteTnRevendedor.MSG_CPF_CADASTRADO))
                msgErro = ConstanteTnRevendedor.MSG_CPF_CADASTRADO;
     ...
     */
    public boolean mantemRevendedor(ViewRevendedor viewRevendedor) throws TransException {
        RevendedorServerImpl serverImpl = new RevendedorServerImpl();
        try {
            viewRevendedor = serverImpl.salvarRevendedor(viewRevendedor);
        } catch (TransException ex) {
            throw ex;
        }
...
//            int opcao = JOptionPane.showConfirmDialog(rootPane, MensagensUtil.MENSAGEM_CONFIRMAR_SAIR, MensagensUtil.ATENCAO, 0);
     ...
     */
    private void populaNewCodigoConsultor() {
        jtxtCodigoRevendedor.setText(buscaNewCodigoRevendedor());
    }

    private String buscaNewCodigoRevendedor() {

        String codigoRetorno = "";
        try {
            RevendedorServerImpl revServerImpl = new RevendedorServerImpl();
            int codigo = revServerImpl.recCodigoSequencia();

            codigoRetorno = MetodosUtil.gerarCodigoFormatoPadrao(codigo);
    ...
    private void pushToModelContato() {
        PessoaFisica pessoa = (PessoaFisica) this.viewRevendedor.getRevendedor().getPessoa();
        pessoa.setTelefones(returnListTelefones(pessoa));
        pessoa.setEmails(returnListEmails(pessoa));
    }
    ...
    private void popularDadosPrincipais() {
        ...
        Date dateNasc = ((PessoaFisica) viewRevendedor.getRevendedor().getPessoa()).getDataNascimento();
    ...
    private boolean validCPF() {
        RevendedorServerImpl serverImpl = new RevendedorServerImpl();
        try {
            if (serverImpl.validaCPF(viewRevendedor.getRevendedor().getPessoa()) != null) {
                JOptionPane.showMessageDialog(this, MessageRevendedor.CAMPO_CPF_CADASTRADO, MensagensUtil.ATENCAO, 2);
                jtxtCPF.requestFocus();
                return false;
            }
        } catch (TransException ex) {
    ...
    public void consultarProspeccoes() {
        try {
            ...
            //faz a busca ao server
            AlertaServerImpl alertaServerImpl = new AlertaServerImpl();

            if (alertaServerImpl.recListaAlertas(prospeccao).isEmpty()) {
                lblAlertaProspeccao.setVisible(false);
            } else {
    ...
    private void buscarDataUltimaCompra() {
        try {
            RevendedorServerImpl revServerImpl = new RevendedorServerImpl();
            PedidoVenda pedido = revServerImpl.recUltimoPedidoVenda(viewRevendedor.getRevendedor());
            if (pedido != null) {
