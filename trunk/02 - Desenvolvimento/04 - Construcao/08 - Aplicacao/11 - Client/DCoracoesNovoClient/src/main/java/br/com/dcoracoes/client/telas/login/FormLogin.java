...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMsgErro.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
     ...
     */
    public void directFormPrincipal() {
     ...
     * Buscar usuario
     */
    private void recUsuarios() {
        SwingWorkerUsuario work = new SwingWorkerUsuario<Usuario>();
        work.setFormLogin(this);
        work.workRecUsuarios.execute();
    }

    public void populaComboUsuario(List<Usuario> usuarios) {
    ...
    /**
     * Inicializa dados para controle de acesso de acordo com o Perfil do
     * Usuario
     */
    public void setControleAcesso(List<AssociaPerfilPermissao> lstAssocia) {
        new ControleAcesso(lstAssocia);
        App.setUserLog(user);
        directFormPrincipal();
    }

    private void recControleAcesso() {
        SwingWorkerAssociaPerfilPermissao work = new SwingWorkerAssociaPerfilPermissao();
        work.setFormLogin(this);
