...
public class FormCompra extends javax.swing.JFrame implements InterfaceCadastroCompleto{
    ...
    private void initComponents() {
        ...
        txtFornecedor.setFont(new java.awt.Font("Tahoma", 1, 11));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jtxtTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE))
...
//        btnSalvarPDF.setEnabled(false);
    ...
    private Produto buscarProduto(String codigo) {  
        ...
        try {
            ...
            Logger.getLogger(FormCompra.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, MessageCompra.ERRO_CONSULTAR_PRODUTO, MensagensUtil.ERRO, 0);
        }
     ...
     * @param pedido
     */
    private boolean mantemPedido(PedidoCompra pedido) throws TransException {
        PedidoServerImpl serverImpl = new PedidoServerImpl();
        try {
             pedido = serverImpl.salvarPedidoCompra(pedido);
        } catch (TransException ex) {
            throw ex;
        }
